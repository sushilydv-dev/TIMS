...
export default function TrainerProfile() {
  ...
  const handleAvatarChange = async (e) => {
    ...
    try {
      ...
      setImgPreview(data); setImgData(data);
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1a1f] via-[#141418] to-[#0c0407] p-5 text-white shadow-[0_8px_28px_rgba(0,0,0,0.22)]">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[9px] text-white/60 font-bold uppercase tracking-wider mb-4">{profile.specialization}</p>
              <div className="flex justify-between items-end">
                <div>
                  <p className="text-[7px] font-bold text-white/40 uppercase">Experience</p>
                  <p className="text-sm font-bold">{profile.experience_year} year{profile.experience_year !== 1 ? "s" : ""}</p>
                </div>
                <div className="text-right">
                  <p className="text-[7px] font-bold text-white/40 uppercase">Email</p>
